...
Code and POD contributions are made with the agreement that rights to 
the contribution will be released and tranferred to the distribution's 
copyright holders. Non-trivial contributions generally warrant attribution 
in the log maintained in the C<Changes> file, though the decision to do 
so is solely that of the copyright holders.

Please refer to the Artistic 2.0 license, contained in the L<LICENSE> file,
included with this distribution for further explanation.

=head1 LICENSE AND COPYRIGHT

Copyright (c) 2000 - 2014 Neil Watkiss.
